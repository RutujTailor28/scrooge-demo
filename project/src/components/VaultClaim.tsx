...
// Mock data
const mockBalance = 15420.50;
const mockClaimLogs = [
  { id: 1, amount: 250.00, timestamp: new Date(Date.now() - 1000 * 60 * 15) },
  { id: 2, amount: 180.75, timestamp: new Date(Date.now() - 1000 * 60 * 45) },
  { id: 3, amount: 320.25, timestamp: new Date(Date.now() - 1000 * 60 * 90) },
  { id: 4, amount: 195.50, timestamp: new Date(Date.now() - 1000 * 60 * 120) },
  { id: 5, amount: 275.00, timestamp: new Date(Date.now() - 1000 * 60 * 180) },
];
